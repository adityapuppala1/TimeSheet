...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // See components/ui/dialog.tsx's DialogContent for why this is w-[calc(100%-2rem)]
        // instead of w-full — same mobile-gutter default, same twMerge override behavior.
