...
const nav: NavItem[] = [
  ...
  { to: "/app/security-insights", label: "Security insights", icon: ShieldAlert, permission: permissions.REPORTS_VIEW },
  ...
  { to: "/app/settings", label: "Workspace settings", icon: Settings, role: "SUPER_ADMIN" }
];
